...
public class MovementResolutionResult {
    ...
    private final List<SectorConflict> conflicts = new ArrayList<>();
    private final List<SectorCapture> captures = new ArrayList<>();
    ...
    public void addConflict(SectorConflict conflict) { conflicts.add(conflict); }
    public void addCapture(SectorCapture capture) { captures.add(capture); }
    ...
    public List<SectorConflict> getConflicts() { return Collections.unmodifiableList(conflicts); }
    public List<SectorCapture> getCaptures() { return Collections.unmodifiableList(captures); }
    ...
    public String toString() {
        return String.format("MovementResolution{resolved=%d, blocked=%d, transitCombats=%d, conflicts=%d, captures=%d}",
                resolved.size(), blocked.size(), transitCombats.size(), conflicts.size(), captures.size());
    }
}
