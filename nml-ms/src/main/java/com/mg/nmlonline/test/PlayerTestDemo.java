...
import com.mg.nmlonline.service.PlayerImportService;
...
public class PlayerTestDemo {
    ...
    private static void testImportPlayersFromJson() {
        ...
        URL playersResource = PlayerTestDemo.class.getClassLoader().getResource("players");
    ...
    private static void testCombatSimulation() {
        ...
        try {
            URL p1 = PlayerTestDemo.class.getClassLoader().getResource("players/player1.json");
            URL p2 = PlayerTestDemo.class.getClassLoader().getResource("players/player2.json");
            if (p1 == null || p2 == null) {
